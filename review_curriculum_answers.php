...
function main(): int
{
    ...
    foreach ($targets as $target) {
        ...
        try {
            ...
            try {
            updateReview($pdo, $caId, buildErrorReviewMessage($e), null);
 ...
 * @return array{review:string, notion_pdf:?string}
 */
function generateReviewWithAttachments(PDO $pdo, string $caId, string $curriculumId, string $answer1, string $answer2, array $notionUrls, array $mediaUrls, string $apiKey): array
{
    $url = sprintf(
...
function buildErrorReviewMessage(Throwable $e): string
{
